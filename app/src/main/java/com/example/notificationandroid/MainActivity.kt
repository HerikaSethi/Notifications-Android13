...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        const val CHANNEL_ID = "my_dummy_channel"
    }
    ...
    private fun showDummyNotification() {
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentTitle("Congratulations! This is a notification in Android 13")
            .setContentText("You have posted a notification to Android 13!!")
